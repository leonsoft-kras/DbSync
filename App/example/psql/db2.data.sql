...
-- 3 unwanted
   insert into testtab (a1,a2,a3,a4,a5,a7) values (348,16, 'zzzzz', '11', to_timestamp('12.12.2012 13:04:00','dd.mm.yyyy hh24:mi:ss'), decode('45000434', 'hex'));

-- 4 different
   insert into testtab (a1,a2,a3,a4,a5,a7) values (348,22, 'ppvvw', '16', to_timestamp('10.10.2012 13:05:00','dd.mm.yyyy hh24:mi:ss'), decode('11111222', 'hex'));
